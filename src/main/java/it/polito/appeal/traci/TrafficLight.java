...
implements StepAdvanceListener
{
	...
	, 
				id, 
				it.polito.appeal.traci.protocol.Constants.TL_NEXT_SWITCH
		...
		, it.polito.appeal.traci.protocol.Constants.CMD_SET_TL_VARIABLE
	
		, id
		, it.polito.appeal.traci.protocol.Constants.TL_PHASE_INDEX)
		;
		...
		, id
		, it.polito.appeal.traci.protocol.Constants.TL_PROGRAM)
		;
	 ...
	 */
	public ReadObjectVarQuery<Integer> queryReadDefaultCurrentPhaseDuration() {
	 ...
	 */
	public Integer getDefaultCurrentPhaseDuration() throws IOException {
